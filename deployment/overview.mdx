...
Your Kit application responds to health checks at the root path or a dedicated endpoint. Configure your platform's health check to:

- **Path**: `/` or your custom health endpoint
...
- [Deploy to Digital Ocean](/deployment/digital-ocean)
