...
description: 'Deploy your Kit application to Digital Ocean App Platform'
icon: 'digital-ocean'
---

[Digital Ocean App Platform](https://www.digitalocean.com/products/app-platform) is a Platform-as-a-Service that supports Docker deployments. This guide walks you through deploying your Kit application.
