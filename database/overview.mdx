...
description: 'Introduction to Kit database layer powered by SeaORM'
icon: 'database'
---

Kit provides a powerful database layer built on top of [SeaORM](https://www.sea-ql.org/SeaORM/), offering a Laravel-inspired experience for working with databases in Rust.
...
use kit::database::{Model, ModelMut, DB};
...
<CardGroup cols={2}>
  ...
  <Card title="Migrations" icon="arrow-up" href="/database/migrations">
