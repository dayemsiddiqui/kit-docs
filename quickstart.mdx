...
This quickstart guide assumes that you have Rust and Cargo already setup and configured on your machine. [Look at this guide](https://rust-lang.org/learn/get-started/) if you want to know how to setup Rust and Cargo on your machine.
